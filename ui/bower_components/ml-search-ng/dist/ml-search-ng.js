...
(function () {
   ...
   * @prop {Object[]} additionalQtext - additional qtext to be added to the current query, but not otherwise surfaced to user
  ...
  angular.extend(MLSearchContext.prototype, {
    ...
    /**
     * Gets the additional qtext
     * @method MLSearchContext#getAdditionalQtext
     *
     * @return {MLSearchContext} `this`.additionalQtext
     */
    getAdditionalQtext: function getAdditionalQtext() {
      return this.additionalQtext;
    },
    ...
    /**
     * Adds additional qtext
     * This is for query text that should be included as an OR on the 
     * word-query, but should not otherwise surface to the user in the
     * params, input box, etc.
     * @method MLSearchContext#addAdditionalQtext
     *
     * @param {Object} additional qtext
     * @return {MLSearchContext} `this`
     */
    addAdditionalQtext: function addAdditionalQtext(text) {
      this.additionalQtext.push(text);
      return this;
    },
    ...
    /**
     * Clear the additional qtext
     * @method MLSearchContext#clearAdditionalQtext
     *
     * @return {MLSearchContext} `this`
     */
    clearAdditionalQtext: function clearAdditionalQtext() {
      this.additionalQtext = [];
      return this;
    },
    ...
    getExpandedQtext: function getExpandedQtext() {
      var allQtexts = this.additionalQtext.concat(this.qtext);
      return allQtexts.join(' OR ');
    },
    ...
    getQuery: function getQuery() {
      ...
      if ( this.qtext ) {
        query = qb.and( query, qb.text(this.getExpandedQtext()) );
      }
